...
const DEFAULT_VIDEO_URL =
  import.meta.env.VITE_VIDEO_URL ?? "http://127.0.0.1:8080/live/stream.m3u8";
...
/**
 * DrownI — Video Panel (ControlBar + Overlay + DetectionTicker)
 */
    ...
    <div className="p-0">
      ...
      <div className="p-4">
        ...
        <div className="mb-2 flex gap-2">
          ...
          />
          <button
            className="px-3 py-1.5 border rounded shadow-sm"
            onClick={() => setUrl(DEFAULT_VIDEO_URL)}
          >
            Reset
          </button>
        </div>
